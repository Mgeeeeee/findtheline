...
const Analyzer = (() => {
  ...
  async function annotateWithGemini(notes, apiKey, onProgress) {
    ...
    for (let i = 0; i < notes.length; i += batchSize) {
      ...
      const prompt = `你是一个笔记分析专家。请对以下${batch.length}条笔记进行多维标注。
每条笔记需要返回：
- themes: 最合适的主题标签（1-3个），从以下选择：AI与人的关系、自我认知、记录与反思、行动与知行、身体与感受、时间与存在、创造与表达、成长与变化、阅读与引用、意义与价值、逃避与面对、投资与理财、梦境、人际与社会、情绪与内耗、游戏、工具与方法、日常随想
- emotion: 情绪基调（1个），从以下选择：沉思、好奇、愉悦、坚定、平静、感慨、焦虑、孤独、温暖、释然、感恩、自嘲、迷茫
- note_type: 笔记类型（1个），从以下选择：生活感悟、名言引用、AI对话感悟、领航员周报、日常此间、梦境记录、提问、想法/点子、工具/教程、投资笔记
- subtext: 这条笔记没有明说的潜台词是什么（一句话，15-25字）
